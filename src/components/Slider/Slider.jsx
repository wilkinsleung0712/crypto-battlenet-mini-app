...
export const Slider = ({ value, max, min = 0, onValueChange }) => {
  return (
    <div className="w-full px-2.5">
      <SliderPrimitive.Root
        className="my-4 relative flex h-1 w-full items-center"
        value={[value]}
        max={max}
        step={1}
        min={min}
      ...
      >
        ...
        <SliderPrimitive.Thumb
          className="block h-[28px] w-[28px] bg-white rounded-[999px]"
          aria-label="Volume"
        />
      </SliderPrimitive.Root>
    </div>
